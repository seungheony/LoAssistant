...
class Abrelshud_56TableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var gate5Button: UIButton!
    @IBOutlet weak var gate6Button: UIButton!
    
//    @IBAction func checkGate(_ sender: UISegmentedControl) {
//        
//        self.checkList![self.charIndex].abrelshud_56 = sender.selectedSegmentIndex
//        print("\(self.charIndex) : \(self.checkList![self.charIndex].abrelshud_56)")
//        
...
//    }
    ...
    @IBAction func gate5ButtonTapped(_ sender: Any) {
        gate6Button.isSelected = false
        gate5Button.isSelected = !gate5Button.isSelected
        
        if gate5Button.isSelected == true {
            delegate?.gateButtonTapped(gateNum: 1)
        }
    }
    @IBAction func gate6ButtonTapped(_ sender: Any) {
        gate5Button.isSelected = true
        gate6Button.isSelected = !gate6Button.isSelected
        
        if gate6Button.isSelected == true {
    ...
    @objc private func didChangeValue(segment: UISegmentedControl) {
        DispatchQueue.global().sync {
            ...
            checkList[self.charIndex].abrelshud_56 = segment.selectedSegmentIndex
            print("\(self.charIndex) : \(checkList[self.charIndex].abrelshud_56)")
